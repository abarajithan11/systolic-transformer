...
#  Generated on:      Tue Mar 21 15:59:01 2023
#  Design:            fullchip
...
set_input_delay -add_delay 0.2 -max -clock [get_clocks {clk}] [get_ports {inst[21]}]
...
set_input_delay -add_delay 0.2 -max -clock [get_clocks {clk}] [get_ports {inst[22]}]
...
set_input_delay -add_delay 0.2 -max -clock [get_clocks {clk}] [get_ports {inst[23]}]
...
set_input_delay -add_delay 0.2 -max -clock [get_clocks {clk}] [get_ports {inst[24]}]
...
set_input_delay -add_delay 0.2 -max -clock [get_clocks {clk}] [get_ports {inst[20]}]
...
set_input_delay -add_delay 0.2 -max -clock [get_clocks {clk}] [get_ports {inst[25]}]
